...
namespace JescoDev.Utility.SmoothBrainTween.Plugins.Runtime.SmoothBrainTween {
    public static partial class EasyEasing {
        ...
        public static TweenHandle SetEaseBackIn(this TweenHandle info) => info.FuncWrapper(EaseBackIn);
        
        public static float EaseBackOut(float x) => 1 + BackConstant3 * Mathf.Pow(x - 1, 3) + BackConstant1 * Mathf.Pow(x - 1, 2);
        public static TweenHandle SetEaseBackOut(this TweenHandle info) => info.FuncWrapper(EaseBackOut);
        ...
        public static TweenHandle SetEaseBackInOut(this TweenHandle info) => info.FuncWrapper(EaseBackInOut);    
    }
}