...
namespace JescoDev.Utility.SmoothBrainTween.Plugins.Runtime.SmoothBrainTween {
    public static partial class EasyEasing {
        ...
        public static TweenInfo SetEaseBackIn(this TweenInfo info) => info.FuncWrapper(EaseBackIn);
        
        public static float EaseBackOut(float x) => 1 + BackConstant3 * Mathf.Pow(x - 1, 3) + BackConstant1 * Mathf.Pow(x - 1, 2);
        public static TweenInfo SetEaseBackOut(this TweenInfo info) => info.FuncWrapper(EaseBackOut);
        ...
        public static TweenInfo SetEaseBackInOut(this TweenInfo info) => info.FuncWrapper(EaseBackInOut);    
    }
}