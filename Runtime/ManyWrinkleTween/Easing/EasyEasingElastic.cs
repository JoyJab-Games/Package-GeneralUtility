...
namespace JescoDev.Utility.SmoothBrainTween.Plugins.Runtime.SmoothBrainTween {
    public static partial class EasyEasing {
        ...
        public static TweenHandle SetEaseElasticIn(this TweenHandle info) => info.FuncWrapper(EaseElasticIn);
        ...
        public static TweenHandle SetEaseElasticOut(this TweenHandle info) => info.FuncWrapper(EaseElasticOut);
        ...
        public static TweenHandle SetEaseElasticInOut(this TweenHandle info) => info.FuncWrapper(EaseElasticInOut);
    }
}